...
export class Edge<T, U> extends Unit<T> {

  public inputNode: Node<T, U>;
  public outputNode: Node<U, T>;
  ...
  _linkTo(node: Node<T, U> | Node<U, T> | any, direction: number) {
  ...
  oppositeNode(node: Node<T, U> | Node<U, T> | any) {
